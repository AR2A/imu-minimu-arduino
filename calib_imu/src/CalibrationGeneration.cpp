...
CalibrationGeneration::CalibrationGeneration(double norm_amplitude_mag,double norm_amplitude_acc, double norm_amplitude_gyr){
	...
	//puts("Align Gravitation to positive z direction. Procced with 'w' when done");
}
CalibrationGeneration::~CalibrationGeneration(){
}

bool CalibrationGeneration::isFinished(){
	return calState==st_FINISHED;
}

void CalibrationGeneration::progressStep(){
	proceed = true;
}

void CalibrationGeneration::CalibrationStep(arma::vec const & input_mag,arma::vec const & input_acc,arma::vec const & input_gyr){
...
void CalibrationGeneration::CalculateVectorsFromCombinedMatrix(CalData & cal){
...
void CalibrationGeneration::InitialiseCalibrationObjectMag(Sensor3DCalibration & cal){
...
void CalibrationGeneration::InitialiseCalibrationObjectAcc(Sensor3DCalibration & cal){
...
void CalibrationGeneration::InitialiseCalibrationObjectGyr(Sensor3DCalibration & cal){
